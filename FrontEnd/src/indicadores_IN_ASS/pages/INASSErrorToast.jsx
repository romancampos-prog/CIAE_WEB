...
export default function INASSErrorToast({ mensaje, trigger = 0 }) {
  ...
  return createPortal(
    <div style={{
      ...
      animation: saliendo ? 'none' : 'inass-errIn 0.4s cubic-bezier(0.16,1,0.3,1) both',
    }}>
      <style>{`
        @keyframes inass-errIn {
      ...
      <div style={{
        ...
        borderRadius: 16,
        boxShadow: '0 8px 32px rgba(180,30,30,0.15), 0 2px 8px rgba(0,0,0,0.06)',
