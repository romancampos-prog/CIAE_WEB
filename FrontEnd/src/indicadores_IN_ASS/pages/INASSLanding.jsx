...
import { getInAssMesesGuardados } from '../api/in_ass';
import './inass.css';
...
const INASSLanding = () => {
  ...
  useEffect(() => {
    getInAssMesesGuardados(anioActual).then(setMesesGuardados);
  }, []);
      ...
      <main className="ia-hub-main">
        ...
        <div className="ia-hub-cards">
          ...
          <div
            ...
            onClick={() => { if (mesesGuardados?.length) navigate('/CIAE/IndicadoresMedicos/INASS/Datos'); }}
          >
          ...
          {/* Nuevo reporte */}
          {puedeGenINASS && (
          <div className="home-card" onClick={() => navigate('/CIAE/IndicadoresMedicos/INASS/Reporte')}>
