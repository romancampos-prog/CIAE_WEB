...
import { INDICADORES as IASS_INDS } from '../../indicadores_IASS/constants/colores';
import FTPGraficasContenido from '../components/graficasFTP/FTPGraficasContenido';
import IASSGraficasContenido from '../../indicadores_IASS/components/IASSGraficasContenido';
import '../pages/ftp.css';
import '../../indicadores_IASS/pages/IASS.css';
...
const GraficasUnificadasPage = () => {
  ...
  const modulo = indSel.startsWith('IASS') ? 'iass' : 'ftp';
  ...
  const todosGrupos = useMemo(() => [
    ...
    { cat: 'IASS', color: IASS_COLOR, inds: IASS_INDS },
  ], [ftpLista]);
