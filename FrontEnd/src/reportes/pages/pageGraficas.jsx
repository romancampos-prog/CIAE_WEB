...
import GBarras from '../../indicadores_FTP/components/graficasFTP/GBarras';
import FilterPanel from '../../indicadores_FTP/components/graficasFTP/FilterPanel';
import logo_imss from '../../assets/logo_imms.png';
import './pageGrafica.css';
import InformacionIndicador from '../components/InformacionIndicador/InformacionIndicador';
import { getIndicador } from '../../indicadores_FTP/api/indicadores';
...
export default function PageGrafica() {
  ...
  const handleVolver = () => {
    if (retornoSeguro) navigate('/CIAE/config', { state: { indicador: Indicador, retornoSeguro } });
    else navigate(-1);
  };
