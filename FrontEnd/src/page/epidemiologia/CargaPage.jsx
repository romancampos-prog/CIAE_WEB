...
import UploadCard from '../../componentes/epidemiologia/upload/UploadCard'
import ReporteToast from '../../componentes/epidemiologia/common/ReporteToast'
import { subirOperativa, subirSiscep } from '../../api/dengue/archivos'
import { useDenguePipeline } from '../../hooks/useDenguePipeline'

export default function CargaPage() {
  const { estado, cargando, ejecutar } = useDenguePipeline()
  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 8 }}>
        <button
          disabled={!ambosListos || corriendo || cargando}
          onClick={ejecutar}
          style={{
      ...
      {/* Toast de reporte — aparece al montar si hay último reporte */}
      <ReporteToast ultimoReporte={estado?.ultimo_reporte} />
