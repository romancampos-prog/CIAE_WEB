    ...
    <div className="home-root">
      ...
      <main className="home-main">
        ...
        <div className="home-cards">
          ...
          {/* ── Indicadores ── */}
          <div className="home-card" onClick={() => navigate('/CIAE/IndicadoresMedicos')}>
            ...
            <div className="hc-header hc-header--green">
              ...
              <div className="hc-header-text">
                <p className="hc-eyebrow">Módulo activo</p>
                <h2 className="hc-name">Indicadores Médicos</h2>
              </div>
            </div>

            <p className="hc-desc">
              Consulta y generación de indicadores mediante la integración 
              de archivos FTP y Exceles de bases.
            </p>

            <div className="hc-footer">
              <div className="hc-chips">
                <span className="hc-chip hc-chip--green">FTP</span>
                <span className="hc-chip hc-chip--green">Excel</span>
              </div>
          ...
          {/* ── Epidemiología ── */}
          <div className="home-card" onClick={() => navigate('/CIAE/Epidemiologia')}>

            <div className="hc-header hc-header--tinto">
              <div className="hc-icon-box hc-icon-box--tinto">
              ...
              <div className="hc-header-text">
                <p className="hc-eyebrow">Módulo activo</p>
                <h2 className="hc-name">Epidemiología</h2>
              </div>
            </div>

            <p className="hc-desc">
              Vigilancia Epidemiológica: Análisis y seguimiento de enfermedades
              prioritarias en el OOAD Guanajuato.
            </p>

            <div className="hc-footer">
              <div className="hc-chips">
                <span className="hc-chip hc-chip--tinto">Dengue</span>
              </div>
              <div className="hc-arrow hc-arrow--tinto">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                  <line x1="5" y1="12" x2="19" y2="12"/>
                  <polyline points="12 5 19 12 12 19"/>
                </svg>
