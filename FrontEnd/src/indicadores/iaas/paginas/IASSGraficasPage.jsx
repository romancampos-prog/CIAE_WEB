...
import TickMesUnidad from '../componentes/graficas/TickMesUnidad';
import { INDICADORES, COLOR_IND } from '../constantes/colores';
...
const IASSGraficasPage = () => {
  ...
  useEffect(() => { document.title = 'IAAS Gráficas | CIAE'; }, []);
                ...
                {unidadesStatus
                  ...
                  .map(({ unidad, color }) => (
                    ...
                    >
                      ...
                      {indSel === 'IAAS 01' && hgsSet.has(unidad) && (
