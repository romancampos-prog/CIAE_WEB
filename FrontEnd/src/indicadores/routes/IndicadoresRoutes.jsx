...
import ExtractorRoutes       from '../extractor/routes/ExtractorRoutes'
import GraficaRoutes         from '../reportes_grafica/routes/GraficaRoutes'
import RoleRoute             from '../../auth/componentes/RoleRoute'

// Visitante solo puede ver gráficas -- generar (FTP/IAAS/Extractor) queda
// bloqueado a nivel de ruta, no solo oculto en la tarjeta, para que tampoco
// se pueda entrar escribiendo la URL directamente.
...
export default function IndicadoresRoutes() {
  return (
    <Routes>
      ...
      <Route path="Extractor/*" element={<RoleRoute roles={ROLES_GENERAR}><ExtractorRoutes /></RoleRoute>} />
