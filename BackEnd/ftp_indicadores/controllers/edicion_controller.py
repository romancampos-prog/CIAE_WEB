"""
Endpoints para editar título, descripción y semáforo de indicadores FTP.
Usado en: ftp_indicadores/__init__.py (prefix /reportes/editar)
"""
from fastapi import APIRouter, HTTPException, Depends
from configs.response import ApiResponse
from auth.services.jwt_utils import solo_roles
from ftp_indicadores.services import editar_service
from ftp_indicadores.models.edicion_models import InfoGeneralUpdate, SemaforoUpdate
