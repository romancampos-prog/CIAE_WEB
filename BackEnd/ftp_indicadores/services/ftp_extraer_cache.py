...
Usado en: ftp_indicadores/services/ (disponible para uso futuro con caché)
"""
import io
import threading
import pandas as pd
...
from ftp_indicadores.services.ftp_extraer  import ExtraerDatosDelExcel, ExtraerPBDesdeJSON, registrar_error
