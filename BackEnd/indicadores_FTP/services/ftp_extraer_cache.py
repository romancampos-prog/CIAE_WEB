"""
Módulo  : ftp_extraer_cache.py
Carpeta : indicadores_FTP/services/
Qué hace: Versión con caché en memoria de ftp_extraer — evita descargar el mismo archivo dos veces en una petición.
Usado en: FTP_service.py (llamado cuando se consultan todos los indicadores)
"""
import io
import threading
import pandas as pd
...
from indicadores_FTP.services.ftp_extraer import ExtraerDatosDelExcel, ExtraerPBDesdeJSON, registrar_error
