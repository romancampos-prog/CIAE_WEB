"""
Módulo  : poblacion_controller.py
Carpeta : indicadores_FTP/controllers/
Qué hace: Recibe y procesa el Excel de población.
Usado en: main.py (prefix /ftp)
"""
from fastapi import APIRouter, UploadFile, File, HTTPException, Depends
from auth.services.jwt_utils import solo_roles
from indicadores_FTP.services.poblacionFTP_service import procesar_archivo_poblacion
