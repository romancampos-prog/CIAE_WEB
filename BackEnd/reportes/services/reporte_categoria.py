"""
Módulo  : reporte_categoria.py
Carpeta : reportes/services/
Qué hace: Pipeline paralelo para generar todos los indicadores de una categoría en un solo Excel.
...
from reportes.services.generar_excel import (
...
def preparar_datos_indicador(indicador: str, ano: str, mes: str, semana) -> dict:
    try:
        ...
        # Guarda histórico en JSON mensual o semanal según corresponda
