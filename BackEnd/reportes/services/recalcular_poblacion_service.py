"""
Módulo  : recalcular_poblacion_service.py
Carpeta : reportes/services/
Qué hace: Recalcula el denominador de los indicadores que usan POBLACION.json
...
Usado en: reportes/controllers/reportes_controller.py  (/recalcular-poblacion)
"""
import math
from indicadores_FTP.services.ftp_extraer import ExtraerPBDesdeJSON
from configs.unidades import UNIDADES_FINALES
...
def actualizar_historico_con_nueva_poblacion(indicador: str, ano: str, info: dict) -> tuple:
    ...
    # ── 3. Calcular resultados y escribir al JSON ─────────────────────────────
    datos_por_mes = {}
