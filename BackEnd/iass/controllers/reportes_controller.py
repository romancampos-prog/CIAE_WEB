...
from iass.services.procesar_service import procesar_IASS as ProcesarIASS
from iass.services.generar_iass import (
...
_EXCEL_POR_IND = {
    "IASS 01": Excel_IASS01, "IASS 02": Excel_IASS02,
    "IASS 03": Excel_IASS03, "IASS 04": Excel_IASS04,
    "IASS 05": Excel_IASS05, "IASS 06": Excel_IASS06,
}
...
async def IASS_descargar(
    ...
    if indicador and indicador in _EXCEL_POR_IND:
        num      = indicador.replace("IASS ", "").zfill(2)
        stream   = _EXCEL_POR_IND[indicador]()
        nombre   = f"IASS_{num}_{anio}.xlsx"
