...
Usado en: ftp_indicadores/controllers/reportes_controller.py
...
"""
import xlsxwriter
from ftp_indicadores.services.ftp_service import obtenerInformacionIndicador
from ftp_indicadores.services.ftp_extraer import ExtraerInformacionPrevia
from ftp_indicadores.services.numerador_denominador import ObtenerNumDen
from ftp_indicadores.services.semaforizado import Semaforizado
from ftp_indicadores.services.generar_excel import (
    obtener_estilos_excel, _leer_historicos, _calcular_color
)
from ftp_indicadores.config import UNIDADES_PREVIOS, UNIDADES_FINALES, NOMBREUNIDADESARCHIVO
from ftp_indicadores.services.datos_json_service import guardar_datos_en_json, guardar_semana_en_json
