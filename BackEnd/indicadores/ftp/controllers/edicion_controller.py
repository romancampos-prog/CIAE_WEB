...
Usado en: ftp/__init__.py (prefix /reportes/editar)
"""
from fastapi import APIRouter, HTTPException, Depends
from configs.response import ApiResponse
from auth.services.jwt_utils import solo_roles
from ftp.services import editar_service
from ftp.models.edicion_models import InfoGeneralUpdate, SemaforoUpdate
