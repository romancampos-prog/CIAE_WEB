...
from epidemiologia.config import (
...
def _ejecutar():
    try:
        from epidemiologia.modulos.depuracion          import depurar_base
        from epidemiologia.modulos.duplicados           import detectar_duplicados
        from epidemiologia.services.canal_service       import procesar_canal
        from epidemiologia.services.clustering_service  import procesar_clustering
        from epidemiologia.services.mapa_service        import procesar_mapa
        from epidemiologia.services.alertas_service     import procesar_alertas
